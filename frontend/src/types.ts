...
export interface RuntimeSettings {
  ...
  auto_apply: { enabled: boolean; min_score: number; require_recommendation_apply: boolean; daily_cap: number; allow_needs_review_answers: boolean; blocked_domains: string[]; notify_each: boolean; email_enabled: boolean; email_per_company_days: number; email_daily_cap: number; email_min_interval_seconds: number };
